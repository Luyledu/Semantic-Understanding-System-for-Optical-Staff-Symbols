...
from utils.NoteSet import L,C,T,S,R,T_S,T_F,BarLine
import fractions
import csv
    ...
    for line in score:
        ...
        for n in range(1,N_n + 1):
            ...
            for pitch in p:
                ...
                encode_note += str(ActualPitch) + '_'
            if v2:
                d = d * (1 + 1/2)
            # encode_note = encode_note + str(fractions.Fraction(d)) + "#" + coo
            encode_note = encode_note + str(fractions.Fraction(d))
...
if __name__ == '__main__':
    mung_path = '/Users/loufengbin/Documents/python/pythonProject/tensorflow/YOLO/yolov5-6.1/runs/detect/1/mung/000202.txt'
