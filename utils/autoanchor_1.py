...
def check_anchors(dataset, model, thr=4.0, imgsz=640):
    ...
    #         y.append(ii[4])
    # plt.scatter(x, y)
    # plt.savefig('/Users/loufengbin/Documents/python/pythonProject/tensorflow/YOLO/yolov5-6.1/asd.jpg')
    # print('yibaocun')
    ...
    if bpr > 0.99999999:  # threshold to recompute
